              ...
              <h2 class="mb-2 title-color">กรอกข้อมูล</h2>
                 <form  class="appoinment-form" method="GET" action="save" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="nearTheCoast" name="nearTheCoast">
                                  <option value=1>ใกล้แม่น้ำ</option>
                                  <option value=0>ไม่ใกล้แม่น้ำ</option>
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-main btn-round-full">สร้างบ้าน<i class="icofont-simple-right ml-2"></i></button>
                        </div>
                  </form>
              </div>
          </div>
